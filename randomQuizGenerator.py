...
#Create folders for quizzes and answers, places quizzes in the quizzes directory and answers in the answers directory
...
capitals = {'Alabama': 'Montgomery', 'Alaska': 'Juneau', 'Arizona': 'Phoenix',
            ...
            #       2. instead of creating quiz and answer files in the current working directory,
            #          create a folder titled 'quizzes' and another folder titled 'answers'.
